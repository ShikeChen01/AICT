...
virt-customize -a "$IMAGE" --memsize 2048 \
    ...
    \
    --install 'xvfb,xdotool,ffmpeg,x11-utils,x11-xserver-utils,x11vnc,openbox,obconf,dbus-x11,xterm,tint2,wmctrl,xclip,python3,python3-pip,python3-venv,curl,git,ca-certificates,gnupg,wget,net-tools,iputils-ping' \
    \
